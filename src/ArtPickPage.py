class Artpickpage(Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.lit_btn = Button(self, text="LITERATURE", width=15, font='Bookman-Old-Style 12 bold', bd=0, bg='white',
                              cursor='hand2', command=lambda: controller.show_frame(Literature))
        self.lit_btn.place(x=200, y=500)

        self.back_btn = Button(self, text="BACK", bd=0, bg='white', fg='black', font='Bookman-Old-Style 12 normal',
                               cursor='hand2', command=lambda: self.back(controller))
        self.back_btn.place(x=200, y=650)
        ...
        self.lit_btn.bind("<Enter>", lambda event: on_enter({'lit_btn': self.lit_btn}))
        self.back_btn.bind("<Enter>", lambda event: on_enter({'back_btn': self.back_btn}))
        ...
        self.lit_btn.bind("<Leave>", lambda event: on_leave({'lit_btn': self.lit_btn}))
        self.back_btn.bind("<Leave>", lambda event: on_leave({'back_btn': self.back_btn}))
    ...
    def back(self, controller):
        logout_timer(controller, Artpickpage.verify)
        if controller:

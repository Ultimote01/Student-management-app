class Sciencepickpage(Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.biology_btn = Button(self, text="BIOLOGY", width=15, font='Bookman-Old-Style 12 bold', bd=0, bg='white',
                             cursor='hand2',command=lambda: controller.show_frame(Biology))
        self.biology_btn.place(x=200, y=500)
        ...
        self.biology_btn.bind("<Enter>", lambda event: on_enter({'biology_btn': self.biology_btn}))
        ...
        self.biology_btn.bind("<Leave>", lambda event: on_leave({'biology_btn': self.biology_btn}))
    ...
    def back(self, controller):
        logout_timer(controller, Sciencepickpage.verify)
        if controller:
